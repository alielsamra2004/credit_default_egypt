...
> **Note:** validation periods below use biannual splits for granular quality checking and do not correspond to the four modelling eras.

| Period | Loans | Default Rate | Target | 
|--------|-------|--------------|--------|
...
## EDA Validation Checks

### Default Rate by Era vs Modelling Targets

| Era | Actual DR | Target Range | 
|-----|-----------|-------------|
| Era 1 (2008–2010) | 14.9% | 7–16% | 
| Era 2 (2011–2014) | 26.5% | 16–30% | 
| Era 3 (2015–2019) | 15.2% | 8–20% | 
| Era 4 (2020–2024) | 17.3% | 8–24% | 

### Demographic Checks

| Check | Actual | Target | 
|-------|--------|--------|
| Under-30 default rate | 25.73% | ~25% | 
| Government sector (code 1) default rate | 10.73% | ~10% | 
| Informal sector (code 3) default rate | 32.73% | ~32% | 

### Correlation Checks

| Check | Actual | Target | 
|-------|--------|--------|
| DTI × Default | +0.259 | >0.25 | 
| Credit_Score_I_Score × Default | −0.172 | <−0.10 | 

### Missingness Trajectory Check

| Variable | 2008 | 2024 | Expected Direction |
|----------|------|------|--------------------|
| Credit_Score_I_Score | 99% | 42% | Decreasing (bureau rollout) | 
| Avg_Monthly_Transactions | 100% | ~5% | Decreasing (digital banking) | 
| Fraud_Risk_Score | 100% | 0% | Decreasing (ML deployment 2020) | 
